...
export const metadata = {
  ...
  description:
    "Монгол Мах - Малчнаас шууд. 2026 оноос Улаанбаатар хотод шинэ махыг хүйтэн хэлхээгээр 24 цагийн дотор хүргэдэг.",
};
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            ...
            <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>
                Монголын малчны хотонд өдөр бүр шинэ мах бэлтгэгддэг. Гэвч хотын
                хэрэглэгч дэлгүүрт очсон хойноо хэд хоногийн өмнөх савласан мах
                л хардаг. Бид энэ ялгаатай байдлыг өөрчилөхөөр ажиллаж байна.
              </p>
              <p>
                Өглөө эрт малчны гар дээрээс авсан махыг 2°C хүйтэн температурт
                шууд цехэд хүргэж, тухайн өдөртөө кг-аар хэрчиж, савлаж, 24
                цагийн дотор таны гэрт хүргэнэ.
              </p>
              <p>
                Үхэр, адуу, хонь, ямаа, тахиа — бүгд гарал үүсэл тодорхой. Мал,
                багц, огноо бүр бүртгэлтэй. Та захиалгын дугаараар яг аль
                сумаас, хэзээ бэлтгэгдсэнийг хянах боломжтой.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-border bg-background p-6">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Өдөр бүрийн нядалгаа, 2°C хүйтэн хэлхээ, 24 цагийн эргэлт.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-background p-6">
              <span className="grid size-10 place-items-center rounded-md bg-primary/12 text-primary">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Багц бүр QR кодтой. Малчин, сум, огноо ил тод.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-background p-6">
              <span className="grid size-10 place-items-center rounded-md bg-primary/12 text-primary">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Улаанбаатартаа захиалснаас хойш 24 цагийн дотор.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-background p-6">
              <span className="grid size-10 place-items-center rounded-md bg-primary/12 text-primary">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Банкны шилжүүлэг, гүйлгээ баталгаажиж, баримт олгоно.
              </p>
            </div>
          </div>
        </div>
        ...
        <ol className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          <li className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Өглөө 05:00–08:00, малын гаралтай хамт бүртгэнэ.
            </p>
          </li>
          <li className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              2°C-д хөргөж, кг-аар жинлэн савлана.
            </p>
          </li>
          <li className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Төлбөрөө төлснөөр захиалга баталгаажна.
            </p>
          </li>
          <li className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Тусгай хөргүүртэй машинаар 24 цагийн дотор.
            </p>
          </li>
        </ol>
      </section>
        ...
        <div className="rounded-2xl border border-border bg-card p-8 lg:p-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-2 text-2xl text-display">
                Асуух зүйл байна уу?
              </h2>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Даваа–Ням 09:00–20:00. Хүргэлт, төлбөр, бүтээгдэхүүний талаар
                лавлана уу.
              </p>
              <div className="mt-6 space-y-2 text-sm">
                ...
                <p className="text-muted-foreground">Улаанбаатар хот</p>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-12">
        <div className="relative overflow-hidden rounded-2xl surface-blood px-6 py-12 text-center sm:px-10">
          ...
          <div className="relative">
            <h2 className="text-3xl text-display">
              Малчнаас шууд. Ил тод. Шинэхэн.
            </h2>
            <p className="mx-auto mt-3 max-w-lg text-sm opacity-90">
              Таны гал тогоонд орж буй махны гарал, хүйтэн хэлхээ бүгд
              хянагдсан.
            </p>
          </div>
        </div>
